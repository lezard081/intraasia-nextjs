      ...
      <div className="flex flex-col min-h-screen">
          ...
          <section className="w-full py-16">
            <div className="container mx-auto px-4 md:px-8 max-w-6xl">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <AnimatedSection direction="center" data-side="left" className="w-full md:w-1/2 order-2 md:order-1">
                  <div className="mb-4">
                ...
                <AnimatedSection direction="center" data-side="right" className="w-full md:w-1/2 order-1 md:order-2">
        ...
        <AnimatedSection>
          ...
          <section className="w-full py-16 bg-gray-100">
            <div className="container mx-auto px-4 md:px-8 max-w-6xl">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <AnimatedSection direction="center" data-side="left" className="w-full md:w-1/2">
                  <div className="w-full h-[300px] relative rounded-lg overflow-hidden shadow">
                    <Image
                ...
                <AnimatedSection direction="center" data-side="right" className="w-full md:w-1/2">
                  <div className="mb-4">
